 ...
 */ export declare class MiniApp {
  ...
  private readonly botInline: any;
  private readonly postEvent: any;
  private readonly createRequestId: any;
  private requestingPhoneAccess: any;
  private requestingWriteAccess: any;
  constructor(props: MiniAppProps);
  private getRequestedContact: any;
  /**
   ...
   */ requestContact({}: ExecuteWithTimeout = {} as never): Promise<RequestedContact>;
  /**
