...
import type { MiniAppHeaderColor } from '../types.ts';
import { RGB } from '../../../colors/types.ts';
import { PostEvent } from '../../../bridge/methods/postEvent.ts';
import { createRequestIdGenerator } from '../../../init/creators/createRequestIdGenerator.ts';
