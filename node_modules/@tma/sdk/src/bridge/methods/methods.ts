import type { AnyInvokeCustomMethodParams } from './custom-methods.ts';
import type { AnyHapticFeedbackParams } from './haptic.ts';
import type { PopupParams } from './popup.ts';
import type { RGB } from '../../colors/types.ts';
import type { Not } from '../../types/logical.ts';
import type { RequestId } from '../../types/request-id.ts';
import type { UnionKeys } from '../../types/unions.ts';
