import type { ClipboardTextReceivedPayload } from './parsers/clipboardTextReceived.ts';
import type { CustomMethodInvokedPayload } from './parsers/customMethodInvoked.ts';
import type { InvoiceClosedPayload } from './parsers/invoiceClosed.ts';
import type { PhoneRequestedPayload } from './parsers/phoneRequested.ts';
import type { PopupClosedPayload } from './parsers/popupClosed.ts';
import type { QrTextReceivedPayload } from './parsers/qrTextReceived.ts';
import type { ThemeChangedPayload } from './parsers/theme-changed.ts';
import type { ViewportChangedPayload } from './parsers/viewportChanged.ts';
import type { WriteAccessRequestedPayload } from './parsers/writeAccessRequested.ts';
import type { EventEmitter } from '../../event-emitter/EventEmitter.ts';
import type { AnySubscribeListener, EventListener, EventParams } from '../../event-emitter/types.ts';
import type { Not } from '../../types/logical.ts';
